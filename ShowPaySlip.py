...
class ShowPaySlipWidget(QWidget):
    ...
    def __init__(self, parent, salary):
        ...
        self.originalPay.setText('%.03f'%(self.salary.originalPay))
        self.gradePay = QLineEdit()
        self.gradePay.setReadOnly(True)
        self.gradePay.setText(str(self.salary.gradePay))
        self.DOJ = QLineEdit()
        ...
        self.presentPay.setText('%.03f'%(self.salary.presentPay))
        self.da = QLineEdit()
        self.da.setReadOnly(True)
        self.da.setText('%.03f'%(self.salary.da))
        self.hra = QLineEdit()
        self.hra.setReadOnly(True)
        self.hra.setText('%.03f'%(self.salary.hra))
        self.ta = QLineEdit()
        self.ta.setReadOnly(True)
        self.ta.setText('%.03f'%(self.salary.ta))
        self.it = QLineEdit()
        self.it.setReadOnly(True)
        self.it.setText('%.03f'%(self.salary.it))
        self.pt = QLineEdit()
        self.pt.setReadOnly(True)
        self.pt.setText('%.03f'%(self.salary.pt))

        self.grossAllowance = QLineEdit()
        self.grossAllowance.setReadOnly(True)
        self.grossAllowance.setText('%.03f'%(self.salary.grossEarnings))
        self.grossDeduction = QLineEdit()
        self.grossDeduction.setReadOnly(True)
        self.grossDeduction.setText('%.03f'%(self.salary.grossDeductions))

        self.netPay = QLineEdit()
        self.netPay.setReadOnly(True)
        self.netPay.setText('%.03f'%(self.salary.netPay))
